...
export const picture = ({ image, maxWidth = 720, maxHeight = 720 }) => {
  ...
  return (
    <picture key={fallback}>
      ...
      <img src={fallback} width={width} height={height} loading="lazy" style={{ backgroundImage: `url(${image.lqip})`, backgroundSize: "cover" }} />
    </picture>
  )
}
